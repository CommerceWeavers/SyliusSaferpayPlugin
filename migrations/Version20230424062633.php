...
final class Version20230424062633 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE cw_saferpay_transaction_log (id INT AUTO_INCREMENT NOT NULL, payment_id INT NOT NULL, occurred_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, context LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_A710468D4C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
